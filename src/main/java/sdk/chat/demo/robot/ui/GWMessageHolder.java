...
public class GWMessageHolder implements IMessage, Consumer<Throwable> {
...
//        }
    ...
    public boolean equals(Object object) {
        return object instanceof GWMessageHolder && getId().equals(((GWMessageHolder)object).getId());
    }
...
//        return message.getText();
    ...
    public static List<Message> toMessages(List<GWMessageHolder> messageHolders) {
        ArrayList<Message> messages = new ArrayList<>();
        for (GWMessageHolder mh: messageHolders) {
